("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequired7c6.register("1jMOh",function(e,t){document.addEventListener("DOMContentLoaded",function(){let e=document.getElementById("modal"),t=document.querySelector(".modal-title-movie"),o=document.querySelector(".movie-details table tbody"),d=document.querySelector(".about-text"),n=document.querySelector(".modal-poster"),l=l=>{let r=`https://api.themoviedb.org/3/movie/${l}?api_key=97fe01addf81f73693338979426ece1e`;fetch(r).then(e=>e.json()).then(l=>{let r=l.title,i=l.vote_count,a=l.popularity,c=l.genres[0].name,s=l.overview,u=l.poster_path;t.textContent=r,o.innerHTML=`
          <tr>
            <td>Vote / Votes</td>
            <td>${i}</td>
          </tr>
...
//# sourceMappingURL=modal-window.c9fd1337.js.map
